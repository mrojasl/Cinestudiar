...
@WebFilter(filterName = "MyFilter",servletNames = {"CarritoServlet","PerfilServlet","YaComproServlet","ServAdmin","inicioServlet","DetallesServlet","OperadorServlet","CalificacionServlet","ReporteServlet"})
