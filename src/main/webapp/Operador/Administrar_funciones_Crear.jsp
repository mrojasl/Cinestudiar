            ...
            <div class="row align-items-start ">
                <div class="col order-1">
                    <form >
                        ...
                        <label class="fw-bold">Restricción Edad:</label><br>
                        <input class="mx-1 my-2" type="radio" id="si" name="restrinción_Edad" value="si">
                        <label for="si">Si</label>
                        <input class="mx-1 my-1"  type="radio" id="no" name="restrinción_Edad" value="no">
                    ...
                    <section>
                        ...
                        <button class="my-2 mx-2" type="button" class="btn btn-default">Añadir</button>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form class="p-2 mx-2 mb-2 d-flex-row ">
                                        ...
                                        <div class="d-flex-row mb-3 ">
                                            <label>Añadir_personal</label><br>
                                            <div class="d-flex justify-content-between">
                                                <input type="text" id="añadir_personal">
                                                <botton type="botton"class="btn btn-secondary p-1"> Añadir</botton>
                                            </div>
                                        </div>
                                    </form>
                ...
                <div class="col order-3">
                    ...
                    <section>
                        <label class="fw-bold container">Descripción</label>
                    ...
                    <br>
                    <section>
                        <button class="mx-4 btn btn-primary btn-lg active btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal1">Crear Función</button>
                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <span class=" border m-4 p-2">
                                                               <p class="text-center">
                                                                 Se ha creado la función con éxito
                                                                </p>
                                                        </span>
