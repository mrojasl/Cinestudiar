...
<nav class="navbar navbar-light" style="background:#114a9d;">
  ...
  <div class="nav2">
    ...
    <a href="${pageContext.request.contextPath}/loguin" class="my-1 mx-1" style="color: white;font-weight: bold;font-size: 17px;font-family: Akzidenz-Grotesk">Inicio de sesión⠀<i class="bi bi-person-fill"></i></a>
    <a href="${pageContext.request.contextPath}/?action=registrar" class="my-1 mx-1" style="color: white;font-weight: bold;font-size: 17px;font-family: Akzidenz-Grotesk">Registrarse⠀<i class="bi bi-book"></i></a>
  </div>
</nav>

<body class="bodycolor" STYLE="  background-image: url('Imagenes/fondo.jpg'); background-size: cover;">
...
<style>
  ...
  .bodycolor {
    ...
    background: #f6f6f6 no-repeat fixed center center;
  }
