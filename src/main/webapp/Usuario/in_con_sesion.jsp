                                ...
                                <div class="row align-items-start">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="boxfuncion">
                                            ...
                                            <a type="button" class="btn btn-outline-info btn-rounded" data-mdb-ripple-color="dark" href="<%=request.getContextPath()%>/detalles?action=detalles&id=<%=listapeliculas.get(k-1).getIdpeliculas()%>">Ver más</a>
                                        </div>
                                    </div>
                                    <% if (k%5==0) {
                                        h=k+1;
